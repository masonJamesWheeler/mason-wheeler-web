...
const PHOTOS: &[(&str, &str, &str)] = &[
    ...
    ("kitchen-dining-nook-closeup.jpg", "Dining nook closeup", "Kitchen"),
    ...
    ("kitchen-sink-dishwasher-corner.jpg", "Sink and dishwasher corner", "Kitchen"),
    ("kitchen-fridge-closeup.jpg", "Stainless steel fridge", "Kitchen"),
    ("bathroom-full-view.jpg", "Bathroom — full view", "Bathroom"),
    ("bathroom-shower-subway-tile.jpg", "Shower with subway tile", "Bathroom"),
    ("bathroom-vanity-closeup.jpg", "Vanity with magnifying mirror", "Bathroom"),
    ...
    ("laundry-washer-dryer.jpg", "In-unit washer and dryer", "Laundry"),
    ("den-wide-shelves-tv.jpg", "Den with shelving area", "Den"),
    ("den-tv-media-console.jpg", "Den — TV and media console", "Den"),
